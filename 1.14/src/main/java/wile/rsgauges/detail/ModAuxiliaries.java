...
public class ModAuxiliaries
{
  ...
  public static final class Tooltip
  {
    ...
    {
      return (
        InputMappings.isKeyDown(ModRsGauges.proxy.mc().mainWindow.getHandle(), GLFW.GLFW_KEY_LEFT_SHIFT) ||
        InputMappings.isKeyDown(ModRsGauges.proxy.mc().mainWindow.getHandle(), GLFW.GLFW_KEY_RIGHT_SHIFT)
      );
    }
    ...
    public static boolean helpCondition()
    {
      return extendedTipCondition() && (
        InputMappings.isKeyDown(ModRsGauges.proxy.mc().mainWindow.getHandle(), GLFW.GLFW_KEY_LEFT_CONTROL) ||
        InputMappings.isKeyDown(ModRsGauges.proxy.mc().mainWindow.getHandle(), GLFW.GLFW_KEY_RIGHT_CONTROL)
      );
    }
