...
public class BlockDayTimerSwitch extends BlockAutoSwitch
{
  ...
  public static class TileEntityDayTimerSwitch extends BlockEnvironmentalSensorSwitch.TileEntityEnvironmentalSensorSwitch implements ITickableTileEntity
  {
    ...
    public void tick()
    {
      ...
      if((!(state.getBlock() instanceof BlockDayTimerSwitch))) return;
      ...
      // state setting
      updateSwitchState(state, (BlockDayTimerSwitch)(state.getBlock()), active, 0);
    }
  }
}
