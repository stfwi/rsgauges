...
public class BlockEntityDetectorSwitch extends BlockAutoSwitch
{
   ...
   */
  public static class TileEntityDetectorSwitch extends TileEntityAutoSwitch implements ITickableTileEntity
  {
          ...
          if(
            (
              world.rayTraceBlocks(
                new RayTraceContext(
                  new Vec3d(e.getPosition().getX()-0.2,e.getPosition().getY()+e.getEyeHeight(),e.getPosition().getZ()-0.2),
                  switch_position,
