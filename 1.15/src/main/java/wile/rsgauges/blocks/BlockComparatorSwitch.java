...
{
  public BlockComparatorSwitch(long config, Block.Properties properties, AxisAlignedBB unrotatedBBUnpowered, @Nullable AxisAlignedBB unrotatedBBPowered, @Nullable ModResources.BlockSoundEvent powerOnSound, @Nullable ModResources.BlockSoundEvent powerOffSound)
  { super(config, properties, unrotatedBBUnpowered, unrotatedBBPowered, powerOnSound, powerOffSound); }

  public BlockComparatorSwitch(long config, Block.Properties properties, AxisAlignedBB unrotatedBBUnpowered, @Nullable AxisAlignedBB unrotatedBBPowered)
  ...
  {
    public TileEntityComparatorSwitch(TileEntityType<?> te_type)
    { super(te_type); }
    ...
    public boolean activation_config(BlockState state, @Nullable PlayerEntity player, double x, double y)
    {
      ...
      if(on_power() < 1) on_power(1);
      {
        ...
        tr.add(separator.deepCopy().appendSibling(ModAuxiliaries.localizable("switchconfig.comparator_switch.threshold_off", TextFormatting.YELLOW, new Object[]{(int)threshold0_off()})));
        tr.add(separator.deepCopy().appendSibling(ModAuxiliaries.localizable("switchconfig.comparator_switch.output_power", TextFormatting.RED, new Object[]{(int)on_power()})));
        tr.add(separator.deepCopy().appendSibling(ModAuxiliaries.localizable("switchconfig.comparator_switch.mode"+((int)acquisition_mode()), TextFormatting.DARK_GREEN, new Object[]{})));
        tr.add(separator.deepCopy().appendSibling(ModAuxiliaries.localizable("switchconfig.comparator_switch.output_power", TextFormatting.RED, new Object[]{(int)on_power()})));
